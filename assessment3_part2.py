# -*- coding: utf-8 -*-
"""Assessment3_part2.ipynb

Automatically generated by Colaboratory.

Original file is located at
    https://colab.research.google.com/drive/1AKzLvwT2xjCjIPTvPlK7dpRcPvsdQ-2y
...
audio_float32 = test[1][1]

audio_float32

scaled_array = (audio_float32 * 32767).astype(np.int16)
reshaped_array = scaled_array.reshape(scaled_array.shape[1])
audio_ok = (test[1][0], reshaped_array)

reshaped_array = scaled_array.reshape(scaled_array.shape[1])

test_ok = (test[1][0], reshaped_array)
...
with interface:
  ...
  with gr.Row():
    with gr.Column():
      ...
      gr.Examples(
        examples=[["/content/Article 7 Efficient Estimation of Word Representations in Vector Space.pdf"],
                  ["/content/Article 9 Transformers in Speech Processing_ Survey.pdf"],
                  ["/content/Article 11 Hidden Technical Debt in Machine Learning Systems.pdf"]],
